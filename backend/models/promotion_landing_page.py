...
class PromotionLandingPage(Base):
    ...
    free_shipping_label = Column(String(160), nullable=False, default="Frete gratis na promocao")
    gift_label_prefix = Column(String(80), nullable=False, default="Brinde")
    gift_fallback_label = Column(String(160), nullable=False, default="Brinde incluido")
