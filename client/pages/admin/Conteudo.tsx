              ...
              <div className="max-w-2xl space-y-6">
                <div className="bg-surface-02 rounded-xl border border-surface-03 p-6 space-y-5">
                  <div className="flex items-center gap-3 pb-3 border-b border-surface-03">
                    <Palette size={20} className="text-gold" />
                    <div>
                      <h3 className="text-cream font-bold">Cores do Tema</h3>
                      <p className="text-stone text-sm">Escolha a cor principal do aplicativo</p>
                    </div>
                  </div>
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                            ...
                            return (
                              <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl border-2 transition-all text-left ${
                                  isSelected
                                    ? "border-gold/60 bg-surface-03"
                                    : "border-surface-03 hover:border-surface-03/80 bg-surface-03/50"
                                }`}
                              >
                                <span
                        ...
                        <div className="pt-2 border-t border-surface-03 space-y-3">
                          <Field label="Cor personalizada" hint="Escolha qualquer cor HEX para o tema">
                            <div className="flex items-center gap-3">
                              <input
                                ...
                                className="w-12 h-10 rounded-lg border border-surface-03 bg-surface-03 cursor-pointer p-0.5"
                              />
                              <span className="text-cream font-mono text-sm">{currentColor}</span>
                              <span
                                className="w-8 h-8 rounded-full border border-surface-03"
                        ...
                        <div className="pt-2 border-t border-surface-03">
                          <p className="text-stone text-xs font-bold uppercase tracking-wider mb-3">Pré-visualização</p>
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full border-2 border-surface-03" style={{ backgroundColor: currentColor }} />
                            <div
                ...
                <div className="bg-surface-02/40 border border-surface-03 rounded-xl p-4">
                  <p className="text-parchment text-sm font-medium mb-1">As mudanças são aplicadas em tempo real</p>
                  <p className="text-stone text-xs">
                    Ao salvar, a cor escolhida será persistida e aplicada globalmente em todo o aplicativo.
                  </p>
                </div>
              </div>
            )}
