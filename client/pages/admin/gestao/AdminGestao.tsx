...
const moduleRoutes: Record<GestaoModuleKey, string> = {
  inventory: "/painel/gestao/estoque",
  cmv: "/painel/gestao/cmv",
  finance: "/painel/gestao/financeiro",
  fiscal: "/painel/gestao/fiscal",
};

const tabs: AdminPageTab<GestaoModuleKey>[] = [
  { id: "inventory", label: "Estoque", icon: Package },
  { id: "cmv", label: "CMV", icon: Calculator },
  ...
  return (
    <AdminPageShell>
      ...
      <AdminPageTabs
        tabs={tabs}
        active={moduleKey}
        onChange={(next) => navigate(moduleRoutes[next])}
      />
      <AdminPageContent>
        {loading && (
