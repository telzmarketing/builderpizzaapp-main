...
export const adminPageMeta: Record<string, PageMeta> = {
  ...
  "/painel/marketing/integracoes": { eyebrow: "Marketing", title: "Integracoes", subtitle: "Conexoes com canais externos" },
  ...
  "/painel/campanhas": { eyebrow: "Fidelizacao", title: "Promocoes & Banners", subtitle: "Ofertas, banners e campanhas promocionais" },
  "/painel/fidelidade": { eyebrow: "Fidelizacao", title: "Fidelidade", subtitle: "Regras, beneficios e pontos dos clientes" },
  "/painel/popup-saida": { eyebrow: "Fidelizacao", title: "Popup de Saida", subtitle: "Captura e retencao no site" },
