...
export default function MoschettieriLogo({ className = "h-10" }: { className?: string }) {
  return (
    ...
    >
      <span className="mb-[-0.12em] text-[0.483em] font-bold leading-[0.85] tracking-[0.03em]">Del Basito By</span>
      <span className="text-[1em] font-bold leading-[0.82] tracking-[0.03em]">Moschettieri</span>
      <span className="mt-[-0.06em] flex w-full items-center gap-[0.35em] text-[0.391em] font-bold leading-none tracking-[0.42em]">
