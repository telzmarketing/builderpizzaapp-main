...
jQuery(document).ready(function($){
     ...
     */
        ...
        // $('.wdt-sidebar-wrapper').parents('$secondary').css('height', $('.wdt-sidebar-wrapper').height());
     ...
     */
        ...
        $("select:not(.dt-select-staff,.wdt-sf-field, .no-select-2)").each(function() {
            $(this).select2();
        });


        // $('.no-select-2').each(function() {
        ...
        if(search_val == "" ){
            ...
            jQuery('.quick_search_results').removeClass('active');
                ...
                jQuery.ajax({
                    ...
                    data: {
                        action:'brewhub_search_data_fetch',
                        search_val:search_val,
                        ajax_call: true,
                        function_call: 'brewhub_search_data_fetch',
